...
const SyncInputSchema = z.object({
    resourceType: z.enum(['Estimate', 'Invoice', 'Customer', 'Item']),
    resourceId: z.string(),
});
...
interface QboCustomer { Id: string; DisplayName: string; PrimaryEmailAddr?: { Address: string }; PrimaryPhone?: { FreeFormNumber: string }; ShipAddr?: any; Active: boolean; CustomerTypeRef?: { name: string; }; }
