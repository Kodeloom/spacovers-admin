                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div v-if="expandedPreviews.has(label.id)" class="label-preview-container">
                      <SplitLabel
                        :order-item="label.labelData.orderItem"
                        :order="label.labelData.orderItem.order"
                        :show-preview="false"
                        :is-print-mode="false"
                      />
                    </div>
...
<!-- Clear All Confirmation Modal -->
    ...
    <PrintWarningModal
      :warning-state="printWarnings.warningState.value"
      ...
      @second-warning-confirm="printWarnings.handleSecondWarningConfirm"
